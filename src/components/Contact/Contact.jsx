...
import { FiFacebook, FiInstagram, FiMail, FiMapPin, FiMessageSquare, FiPhone, FiSend, FiUser } from "react-icons/fi";
        ...
        >
          ...
          <div className="bg-tertiary rounded-3xl p-6 md:p-8 border border-white/10 dark:border-white/10 border-black/10 shadow-2xl mt-auto">
            ...
            <div className="flex gap-4 justify-between sm:justify-start">
              ...
              <motion.a
                href="https://www.instagram.com/samyak_anand17/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-xl bg-primary/50 border border-white/10 dark:border-white/10 border-black/10 flex items-center justify-center text-secondary hover:text-white hover:bg-[#E1306C] hover:border-[#E1306C] transition-all duration-300"
                whileHover={{ y: -5 }}
              >
                <FiInstagram className="w-6 h-6" />
              </motion.a>
              <motion.a
                href="https://www.facebook.com/samyak.anand.9"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-xl bg-primary/50 border border-white/10 dark:border-white/10 border-black/10 flex items-center justify-center text-secondary hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all duration-300"
                whileHover={{ y: -5 }}
              >
