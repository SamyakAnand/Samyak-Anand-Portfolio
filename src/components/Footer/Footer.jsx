...
const Footer = () => {
  ...
  return (
    <footer className="relative mt-20 border-t border-white/10 dark:border-white/10 border-black/10 bg-primary overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto py-16 px-[7vw] md:px-[7vw] lg:px-[10vw] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          >
            <motion.h2
              className="text-3xl font-bold text-white-100 mb-6 flex items-center"
            ...
            <motion.p
              className="text-secondary mb-8 max-w-md leading-relaxed"
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-tertiary flex items-center justify-center group-hover:bg-purple-500/20 transition-colors duration-300">
                  <FaEnvelope className="text-secondary group-hover:text-purple-500 transition-colors" />
                </div>
                <a href="mailto:samyak.g.anand@gmail.com" className="text-secondary hover:text-white-100 transition-colors">
          ...
          >
            <motion.h3
              className="text-xl font-bold text-white-100 mb-8"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
            >
            ...
            <nav className="grid grid-cols-1 gap-4">
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  className="text-secondary hover:text-purple-500 text-base font-medium transition-all duration-300 text-left flex items-center gap-2 group"
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  className="w-12 h-12 rounded-xl bg-tertiary flex items-center justify-center text-secondary hover:text-white-100 hover:bg-purple-600 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-purple-500/30 border border-white/5 dark:border-white/5 border-black/5"
            ...
            {/* CTA */}
            <motion.div
              className="bg-tertiary p-6 rounded-2xl border border-white/10 dark:border-white/10 border-black/10 relative overflow-hidden group shadow-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              ...
              <motion.h4
                className="text-lg font-bold text-white-100 mb-2 relative z-10"
              ...
              <motion.p
                className="text-secondary text-sm mb-6 relative z-10"
                initial={{ opacity: 0, x: -10 }}
                animate={{ opacity: 1, x: 0 }}
        ...
        {/* Divider */}
        <motion.div
          className="h-px bg-gradient-to-r from-transparent via-white/10 dark:via-white/10 via-black/10 to-transparent my-12"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <a href="#" className="text-secondary hover:text-purple-500 text-sm transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-secondary hover:text-purple-500 text-sm transition-colors">
              Terms of Service
